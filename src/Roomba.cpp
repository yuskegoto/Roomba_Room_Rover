...
/**
 * @brief Reads out stream data packet from Roomba
 * 
 * @return int16_t* 
 */
...
/**
 * @brief Feature to get XY coordination from encoder readings. Not really functional
 * 
 * @param encoderL 
 * @param encoderR 
 */
